...
class _NFTTransferPageState extends State<NFTTransferPage> {
  ...
  void trant() async {
    ...
    SuiTansaction? result = await suiWallet.transferNFT(
        data!, addressController.text, pwdController.text);
                ...
                Column(
                  children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image(
                                image: NetworkImage(data!.fields["url"]),
                                fit: BoxFit.cover,
                                height: 60,
                                width: 60,
                    ...
                    Container(
                      ...
                      child: Text(
                        S.current.Recelving_Address,
                        style: const TextStyle(
                            color: APP_MainTextGrayColor, fontSize: 15),
                      ),
                    ),
                    Container(
                            ...
                            children: [
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      S.current.Please_input_password_address,
                                      style: const TextStyle(
