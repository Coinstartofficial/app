...
class _SwapRecordDetailPageStateNew extends State<SwapRecordDetailPageNew> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(S.current.Swap_Record_Details),
        ),
        body: Container(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        "${(true ? "-" : "+") + (NumUtil.getNumByValueDouble(neverDoubleTryOrZero("39001000000000") / 1000000000, 9)).toString()} $coin",
                        style: const TextStyle(
                            color: Colors.white,
                            fontSize: 36,
                    ...
                    const SizedBox(height: 15),
                    getAddresRowWith(S.current.Receive_Address,
                        '0x12dge474ccgejgighdigegildgeijilc3dadbgeiddxba'),
                    const SizedBox(height: 15),
                    getAddresRowWith(S.current.Send_Address,
                        '0x12dge474ccgejgighdigegildgeijilc3dadbgeiddxba'),
                    const SizedBox(height: 15),
