                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  if (pwd == pwdController.text) {
                                    Navigator.pop(context);
                                    String privateKey = suiWallet
                                        .getPrivateKey(pwdController.text);
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                            fontSize: 18, color: APP_MainRedColor),
                      ),
                    ),
                  )),
            ],
